...
const Getvehicle = () => {
    return (
        <div className='inter flex flex-col gap-10'>
            ...
            <div className='container grid grid-cols-3 pt-[2rem] w-full'>
                <div className='flex items-center gap-[30px]'>
                    <div className='w-[90%] h-[35vh] gap-3 justify-center flex flex-col items-center shadow-xl'>
                        <div>
                ...
                <div className='w-[90%] h-[35vh] gap-3 justify-center flex flex-col items-center shadow-xl'>
                    <div>
                        <p className='p-4 flex items-center justify-center rounded-full w-[10px] h-[10px] bg-[#81D9F8] text-white'>1</p>
                    </div>
